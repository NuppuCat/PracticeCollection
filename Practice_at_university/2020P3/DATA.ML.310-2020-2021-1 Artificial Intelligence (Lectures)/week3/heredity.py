...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        #              m.append(PROBS["gene"][0]*PROBS["trait"][0][False])
        #          else:
        #              m.append(PROBS["gene"][0]*PROBS["trait"][0][True])
        #     elif (person not in have_trait):
        #          m.append(PROBS["gene"][2]*PROBS["trait"][2][False])
        #     else:
        #          m.append(PROBS["gene"][2]*PROBS["trait"][2][True])
        # elif  (person not in have_trait):
        #      m.append(PROBS["gene"][1]*PROBS["trait"][1][False])
